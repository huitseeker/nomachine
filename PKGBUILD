...
source_armv7h=("http://download.nomachine.com/download/6.0/Arm/${pkgname}_${pkgver}_${_pkgrel_armv7h}_armv7hl.tar.gz")
source_armv8h=("http://download.nomachine.com/download/6.0/Arm/${pkgname}_${pkgver}_${_pkgrel_armv8h}_aarch64.tar.gz")
